...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct WorkspaceGoalListParams {
    pub workspace_key: String,
    #[ts(optional = nullable)]
    pub statuses: Option<Vec<WorkspaceGoalStatus>>,
}

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct WorkspaceGoalListResponse {
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct WorkspaceGoalCreateParams {
    pub workspace_key: String,
    pub objective: String,
    #[ts(optional = nullable)]
    pub source: Option<WorkspaceGoalSource>,
    #[ts(optional = nullable, type = "number | null")]
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct WorkspaceGoalCreateResponse {
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct WorkspaceGoalUpdateParams {
    pub id: String,
    #[ts(optional = nullable)]
    pub status: Option<WorkspaceGoalStatus>,
    #[ts(optional = nullable, type = "number | null")]
    pub priority: Option<i64>,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct WorkspaceGoalUpdateResponse {
    pub goal: Option<WorkspaceGoal>,
}

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct WorkspaceGoalArchiveParams {
    pub id: String,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct WorkspaceGoalArchiveResponse {
    pub goal: Option<WorkspaceGoal>,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub enum OrchestratorVerificationOutcome {
    Passed,
    Failed,
    NeedsHuman,
    SkippedTrivial,
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorScheduleSetParams {
    pub workspace_key: String,
    #[ts(type = "number")]
    pub cadence_seconds: i64,
    #[serde(default, skip_serializing_if = "std::ops::Not::not")]
    ...
    pub model_override: Option<String>,
    #[ts(optional = nullable, type = "number | null")]
    pub max_spawned_agents: Option<i64>,
    #[ts(optional = nullable, type = "number | null")]
    pub max_run_seconds: Option<i64>,
    #[ts(optional = nullable, type = "number | null")]
    pub base_token_budget: Option<i64>,
    #[ts(optional = nullable, type = "number | null")]
    pub min_token_budget: Option<i64>,
    #[ts(optional = nullable, type = "number | null")]
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorScheduleSetResponse {
    pub schedule: OrchestratorSchedule,
}

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorScheduleListParams {
    pub workspace_key: String,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorScheduleListResponse {
    pub schedules: Vec<OrchestratorSchedule>,
}

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorScheduleDeleteParams {
    pub id: String,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorScheduleDeleteResponse {
    pub deleted: bool,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorRunTriggerParams {
    pub workspace_key: String,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorRunTriggerResponse {
    pub run_id: String,
}
...
pub struct OrchestratorRun {
    ...
    pub loop_flags: JsonValue,
    pub verifier_outcome: Option<OrchestratorVerificationOutcome>,
    pub goal_updates: JsonValue,
    #[ts(type = "number")]
    pub started_at: i64,
    #[ts(type = "number | null")]
    pub completed_at: Option<i64>,
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorRunListParams {
    pub workspace_key: String,
    #[ts(optional = nullable, type = "number | null")]
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorRunListResponse {
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorRunReadParams {
    pub id: String,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorRunReadResponse {
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorOpportunityListParams {
    pub workspace_key: String,
    #[ts(optional = nullable)]
    pub statuses: Option<Vec<OrchestratorOpportunityStatus>>,
}

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorOpportunityListResponse {
    pub opportunities: Vec<OrchestratorOpportunity>,
}

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorOpportunityUpdateParams {
    pub id: String,
    pub status: OrchestratorOpportunityStatus,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorOpportunityUpdateResponse {
    pub opportunity: Option<OrchestratorOpportunity>,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorLedgerListParams {
    pub workspace_key: String,
    #[ts(optional = nullable, type = "number | null")]
    pub limit: Option<i64>,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorLedgerListResponse {
    pub entries: Vec<OrchestratorWorkLedgerEntry>,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct WorkspaceGoalUpdatedNotification {
    pub goal: WorkspaceGoal,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorRunStartedNotification {
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorRunUpdatedNotification {
    pub run: OrchestratorRun,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorRunCompletedNotification {
    pub run: OrchestratorRun,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorLoopDetectedNotification {
    pub run_id: String,
    pub workspace_key: String,
    pub flags: JsonValue,
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorVerificationCompletedNotification {
    pub run_id: String,
    pub outcome: OrchestratorVerificationOutcome,
    pub summary: Option<String>,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct OrchestratorBudgetAdjustedNotification {
    pub schedule_id: String,
    #[ts(type = "number")]
    pub previous_token_budget: i64,
    #[ts(type = "number")]
    pub current_token_budget: i64,
    pub reason: String,
}
