...
client_request_definitions! {
    ...
    #[experimental("workspace/goal/list")]
    WorkspaceGoalList => "workspace/goal/list" {
        params: v2::WorkspaceGoalListParams,
        serialization: global("orchestrator"),
        response: v2::WorkspaceGoalListResponse,
    },
    #[experimental("workspace/goal/create")]
    WorkspaceGoalCreate => "workspace/goal/create" {
        params: v2::WorkspaceGoalCreateParams,
        serialization: global("orchestrator"),
        response: v2::WorkspaceGoalCreateResponse,
    },
    #[experimental("workspace/goal/update")]
    WorkspaceGoalUpdate => "workspace/goal/update" {
        params: v2::WorkspaceGoalUpdateParams,
        serialization: global("orchestrator"),
        response: v2::WorkspaceGoalUpdateResponse,
    },
    #[experimental("workspace/goal/archive")]
    WorkspaceGoalArchive => "workspace/goal/archive" {
        params: v2::WorkspaceGoalArchiveParams,
        serialization: global("orchestrator"),
        response: v2::WorkspaceGoalArchiveResponse,
    },
    #[experimental("orchestrator/schedule/set")]
    OrchestratorScheduleSet => "orchestrator/schedule/set" {
        params: v2::OrchestratorScheduleSetParams,
        serialization: global("orchestrator"),
        response: v2::OrchestratorScheduleSetResponse,
    },
    #[experimental("orchestrator/schedule/list")]
    OrchestratorScheduleList => "orchestrator/schedule/list" {
        params: v2::OrchestratorScheduleListParams,
        serialization: global("orchestrator"),
        response: v2::OrchestratorScheduleListResponse,
    },
    #[experimental("orchestrator/schedule/delete")]
    OrchestratorScheduleDelete => "orchestrator/schedule/delete" {
        params: v2::OrchestratorScheduleDeleteParams,
        serialization: global("orchestrator"),
        response: v2::OrchestratorScheduleDeleteResponse,
    },
    #[experimental("orchestrator/run/trigger")]
    OrchestratorRunTrigger => "orchestrator/run/trigger" {
        params: v2::OrchestratorRunTriggerParams,
        serialization: global("orchestrator"),
        response: v2::OrchestratorRunTriggerResponse,
    },
    #[experimental("orchestrator/run/list")]
    OrchestratorRunList => "orchestrator/run/list" {
        params: v2::OrchestratorRunListParams,
        serialization: global("orchestrator"),
        response: v2::OrchestratorRunListResponse,
    },
    #[experimental("orchestrator/run/read")]
    OrchestratorRunRead => "orchestrator/run/read" {
        params: v2::OrchestratorRunReadParams,
        serialization: global("orchestrator"),
        response: v2::OrchestratorRunReadResponse,
    },
    #[experimental("orchestrator/opportunity/list")]
    OrchestratorOpportunityList => "orchestrator/opportunity/list" {
        params: v2::OrchestratorOpportunityListParams,
        serialization: global("orchestrator"),
        response: v2::OrchestratorOpportunityListResponse,
    },
    #[experimental("orchestrator/opportunity/update")]
    OrchestratorOpportunityUpdate => "orchestrator/opportunity/update" {
        params: v2::OrchestratorOpportunityUpdateParams,
        serialization: global("orchestrator"),
        response: v2::OrchestratorOpportunityUpdateResponse,
    },
    #[experimental("orchestrator/ledger/list")]
    OrchestratorLedgerList => "orchestrator/ledger/list" {
        params: v2::OrchestratorLedgerListParams,
        serialization: global("orchestrator"),
        response: v2::OrchestratorLedgerListResponse,
    },
...
server_notification_definitions! {
    ...
    #[experimental("workspace/goal/updated")]
    WorkspaceGoalUpdated => "workspace/goal/updated" (v2::WorkspaceGoalUpdatedNotification),
    #[experimental("orchestrator/run/started")]
    OrchestratorRunStarted => "orchestrator/run/started" (v2::OrchestratorRunStartedNotification),
    #[experimental("orchestrator/run/updated")]
    OrchestratorRunUpdated => "orchestrator/run/updated" (v2::OrchestratorRunUpdatedNotification),
    #[experimental("orchestrator/run/completed")]
    OrchestratorRunCompleted => "orchestrator/run/completed" (v2::OrchestratorRunCompletedNotification),
    #[experimental("orchestrator/loop/detected")]
    OrchestratorLoopDetected => "orchestrator/loop/detected" (v2::OrchestratorLoopDetectedNotification),
    #[experimental("orchestrator/verification/completed")]
    OrchestratorVerificationCompleted => "orchestrator/verification/completed" (v2::OrchestratorVerificationCompletedNotification),
    #[experimental("orchestrator/budget/adjusted")]
    OrchestratorBudgetAdjusted => "orchestrator/budget/adjusted" (v2::OrchestratorBudgetAdjustedNotification),
...
mod tests {
    ...
    #[test]
    fn orchestrator_methods_are_marked_experimental() {
        let workspace_goal_list = ClientRequest::WorkspaceGoalList {
            request_id: RequestId::Integer(1),
            params: v2::WorkspaceGoalListParams {
                workspace_key: "/repo".to_string(),
                statuses: Some(vec![v2::WorkspaceGoalStatus::Active]),
            },
        };
        let schedule_set = ClientRequest::OrchestratorScheduleSet {
            request_id: RequestId::Integer(2),
            params: v2::OrchestratorScheduleSetParams {
                workspace_key: "/repo".to_string(),
                ...
                role_override: None,
                model_override: None,
                max_spawned_agents: Some(2),
                max_run_seconds: Some(300),
                base_token_budget: Some(20_000),
                min_token_budget: Some(5_000),
                max_token_budget: Some(50_000),
            },
        };
        let run_trigger = ClientRequest::OrchestratorRunTrigger {
            request_id: RequestId::Integer(3),
            params: v2::OrchestratorRunTriggerParams {
                workspace_key: "/repo".to_string(),
            },
        };
        let ledger_list = ClientRequest::OrchestratorLedgerList {
            request_id: RequestId::Integer(4),
            params: v2::OrchestratorLedgerListParams {
                workspace_key: "/repo".to_string(),
                limit: Some(50),
        ...
        assert_eq!(
            crate::experimental_api::ExperimentalApi::experimental_reason(&workspace_goal_list),
            Some("workspace/goal/list")
        );
        assert_eq!(
            crate::experimental_api::ExperimentalApi::experimental_reason(&schedule_set),
            Some("orchestrator/schedule/set")
        );
        assert_eq!(
            crate::experimental_api::ExperimentalApi::experimental_reason(&run_trigger),
            Some("orchestrator/run/trigger")
        );
        assert_eq!(
            crate::experimental_api::ExperimentalApi::experimental_reason(&ledger_list),
            Some("orchestrator/ledger/list")
        );
    }

    #[test]
    fn orchestrator_notifications_are_marked_experimental() {
        let run = v2::OrchestratorRun {
            id: "run-1".to_string(),
            schedule_id: Some("schedule-1".to_string()),
            workspace_key: "/repo".to_string(),
            phase: v2::OrchestratorRunPhase::Scout,
            status: v2::OrchestratorRunStatus::Running,
            scout_tokens: 100,
            execution_tokens: 0,
            subagent_tokens: 0,
            budget_used: 100,
        ...
        let started =
            ServerNotification::OrchestratorRunStarted(v2::OrchestratorRunStartedNotification {
                run: run.clone(),
            });
        let loop_detected = ServerNotification::OrchestratorLoopDetected(
            v2::OrchestratorLoopDetectedNotification {
                run_id: run.id.clone(),
                workspace_key: run.workspace_key.clone(),
                flags: json!(["repeated_wait"]),
        ...
        assert_eq!(
            ...
            Some("orchestrator/run/started")
        );
        assert_eq!(
            crate::experimental_api::ExperimentalApi::experimental_reason(&loop_detected),
            Some("orchestrator/loop/detected")
        );
    }
